/**
 * RespuestaComprobanteAutorizaciones.java
 *
...
public class RespuestaComprobanteAutorizaciones  implements java.io.Serializable {
    private autorizacion.ws.sri.gob.ec.Autorizacion[] autorizacion;

    public RespuestaComprobanteAutorizaciones() {
    }
    ...
    /**
     * Gets the autorizacion value for this RespuestaComprobanteAutorizaciones.
     * 
     * @return autorizacion
     */
    ...
    /**
     * Sets the autorizacion value for this RespuestaComprobanteAutorizaciones.
     * 
     * @param autorizacion
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RespuestaComprobanteAutorizaciones)) return false;
        RespuestaComprobanteAutorizaciones other = (RespuestaComprobanteAutorizaciones) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RespuestaComprobanteAutorizaciones.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ec.gob.sri.ws.autorizacion", ">respuestaComprobante>autorizaciones"));
